...
cPuPPack = "BladeRunner2049"    ' name of the PuP-Pack / PuPVideos folder for this table
...
Const cGameName = "BladeRunner2049"
...
Const HSCSV_File   = "D:\vPinball\HighScores\Blade Runner 2049.csv"
    ...
    If Coins(CurrentPlayer)> 249 AND BallType <4 Then
        ...
        Select case BallType
            ...
            Case 2:DMD "", "", "greatball", eNone, eNone, eBlinkFast, 1000, True, "" 
				pupevent 325
            Case 3:DMD "", "", "ultraball", eNone, eNone, eBlinkFast, 1000, True, ""
				pupevent 326
            Case 4:DMD "", "", "masterball", eNone, eNone, eBlinkFast, 1000, True, ""
				pupevent 327
        End Select
        UpdateBallType
    End If
...
Sub VenusaurLock2_Hit()
    ...
    Addscore 20000
    VenusaurShake
	pupevent 304 'venasaur warming up
    LockLight2.State = 1
    CheckLock
End Sub
...
Sub VenusaurMultiball()
	...
	pupevent 301 'VenasaurMultiBall
End Sub
...
Sub LoopTrigger_Hit()
    If bLoopBonus Then
        ...
        FlashForMs Flasher10, 1000, 50, 0
        GiEffect 1
		pupevent 311 'loop bonus trigger
    End If
