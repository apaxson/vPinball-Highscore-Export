...
'*****************<CHOOSE HOW MANY SCREENS YOU WANT >***************************************************************

'************************************************CHOOSE FPS***********************************************************************

Const FPS = 0			' Slow PC Recommended = 0 ****  Fast PC Recommended = 1

Const PupScreen6 = 1		'LeftApron Off = 0 / ON = 1 **** On High Quality = 2 ****  Slow PC = 0 or = 1
Const PupScreen7 = 1	   'RightApron Off = 0 / ON = 1 **** On High Quality = 2 ****  Slow PC = 0 or = 1
...
'Lane Bonus
    ...
    Case 1: PlaySound"BallLost1" : pupevent 803 

    Case 2: PlaySound"BallLost2" : pupevent 828

    Case 3: PlaySound"BallLost3" : pupevent 829
...
Sub Drain_Hit()
    ...
    If(bGameInPLay = True)AND(Tilted = False)Then
        ...
        If(bBallSaverActive = True)Then
            ...
            DMD "_", CL("BALL SAVED"), "_", eNone, eBlinkfast, eNone, 800, True, "" : pupevent 802
        Else
...
Sub AwardExtraBall()
    If NOT bExtraBallWonThisBall Then
        DMD "_", CL(("EXTRA BALL WON")), "_", eNone, eBlink, eNone, 1500, True, SoundFXDOF("fx_Knocker", 122, DOFPulse, DOFKnocker) : pupevent 826
        DOF 121, DOFPulse
        ExtraBallsAwards(CurrentPlayer) = ExtraBallsAwards(CurrentPlayer) + 1
...
Sub AwardSpecial()
    DMD "_", CL(("EXTRA GAME WON")), "_", eNone, eBlink, eNone, 1500, True, SoundFXDOF("fx_Knocker", 122, DOFPulse, DOFKnocker) : : pupevent 827
    DOF 121, DOFPulse
    Credits = Credits + 1
    If bFreePlay = False Then DOF 125, DOFOn
    LightEffect 2
...
Sub AwardSkillshot()
    ...
    'show dmd animation
    DMD CL(FormatScore(SkillshotValue(CurrentPlayer))), CL(("SKILLSHOT")), "d_border", eBlinkFast, eBlink, eNone, 1000, True, ""  : pupevent 825
    DOF 127, DOFPulse
...
Const HSCSV_File   = "D:\vPinball\HighScores\Dune.csv"
    ...
    If UseFlexDMD Then
        ...
        If Not FlexDMD is Nothing Then
            If FlexDMDHighQuality Then
                ...
                For i = 0 to 19 ' Top
                    DMDScene.GetImage("Dig" & i).SetBounds 8 + i * 25, 20, 25, 36
                Next
                For i = 20 to 39 ' Bottom
                    DMDScene.GetImage("Dig" & i).SetBounds 8 + (i - 20) * 25, 80, 25, 36
                Next
...
Sub Check2BankTargets
    If light11.state + light10.state = 2 Then
        ...
        If(Light27.State = 0)AND(bMultiballMode = FALSE)Then 'lit the lock light if it is off, rise the lock post and activate the lock switch
            ...
            DMD "_", CL("LOCK IS LIT"), "_", eNone, eBlinkFast, eNone, 1000, True, "" : pupevent 832
...
Sub lock_Hit
    ...
    If light27.State = 1 Then 'lock the ball
        ...
        Select Case BallsInLock(CurrentPlayer)
            Case 1:DMD "_", CL("BALL 1 LOCKED"), "_", eNone, eBlinkFast, eNone, 1000, True, "vo_ball1locked" : pupevent 804
            Case 2:DMD "_", CL("BALL 2 LOCKED"), "_", eNone, eBlinkFast, eNone, 1000, True, "vo_ball2locked" : pupevent 805
            Case 3:DMD "_", CL("BALL 3 LOCKED"), "_", eNone, eBlinkFast, eNone, 1000, True, "vo_ball3locked" : pupevent 806
        End Select
        light27.State = 0
...
Sub StartMainMultiball
    AddMultiball 3
    DMD "_", CL("FREMEN MULTIBALL"), "_", eNone, eBlinkFast, eNone, 1000, True, "vo_multiball" : pupevent 807
    StartJackpots
    ChangeGi blue
...
Sub GiveRandomAward() 'from the Pyramid
    ...
    Select Case tmp
        Case 1, 2, 3, 4, 5, 6 'Lit Extra Ball
            DMD "", CL("EXTRA BALL IS LIT"), "", eNone, eBlink, eNone, 1500, True, "fx_fanfare1" : pupevent 808
            light23.State = 2
        ...
        Case 9, 10, 11, 12 'Hold Bonus
            DMD CL("BONUS HELD"), CL("ACTIVATED"), "", eBlink, eBlink, eNone, 1500, True, "fx_fanfare1" : pupevent 844
            bBonusHeld = True
        Case 16, 17, 18 'Increase Bonus Multiplier
            DMD CL("INCREASED"), CL("BONUS X"), "", eBlink, eBlink, eNone, 1500, True, "fx_fanfare1" : pupevent 841
            AddBonusMultiplier 1
        Case 19, 20, 21 'Complete Battle
            If Battle(CurrentPlayer, 0) > 0 AND Battle(CurrentPlayer, 0) < 13 Then
                DMD CL("BATTLE"), CL("COMPLETED"), "", eBlink, eBlink, eNone, 1500, True, "fx_fanfare1" : pupevent 809
                WinBattle
            Else
                DMD CL("BIG POINTS"), CL("100000"), "", eBlink, eBlink, eNone, 1500, True, "fx_fanfare1"
                AddScore 100000
        ...
        Case 22, 23, 36, 37, 38 'PlayField multiplier
            DMD CL("INCREASED"), CL("PLAYFIELD X"), "", eBlink, eBlink, eNone, 1500, True, "fx_fanfare1" : pupevent 840
            AddPlayfieldMultiplier 1
        Case 24, 25, 26, 27, 28 '100,000 points
            DMD CL("BIG POINTS"), CL("100000"), "", eBlink, eBlink, eNone, 1500, True, "fx_fanfare1" : pupevent 839
            AddScore 100000
        Case 29, 30, 31, 32, 33, 34, 35 'Increase Bumper value
            BumperValue(CurrentPlayer) = BumperValue(CurrentPlayer) + 500
            DMD CL("BUMPER VALUE"), CL(BumperValue(CurrentPlayer)), "", eBlink, eBlink, eNone, 1500, True, "fx_fanfare1" : pupevent 842
        Case 39, 40, 43, 44 'extra multiball
            DMD CL("EXTRA"), CL("MULTIBALL"), "", eBlink, eBlink, eNone, 1500, True, "fx_fanfare1" : pupevent 837
            AddMultiball 1
        Case 45, 46, 47, 48 ' Ball Save
            DMD CL("BALL SAVE"), CL("ACTIVATED"), "", eBlink, eBlink, eNone, 1500, True, "fx_fanfare1" : pupevent 843
            EnableBallSaver 20
        Case ELSE 'Add a Random score from 10.000 to 100,000 points
            tmp2 = INT((RND) * 9) * 10000 + 10000
            DMD CL("EXTRA POINTS"), CL(tmp2), "", eBlink, eBlink, eNone, 1500, True, "fx_fanfare1" : pupevent 838
            AddScore tmp2
    End Select
End Sub
...
Sub LeftRampDone_Hit
    ...
    if LastSwitchHit = "LeftRampDone" Then
        Addscore jackpot(CurrentPlayer)
        DMD CL("COMBO"), CL(jackpot(CurrentPlayer)), "_", eNone, eBlinkFast, eNone, 1000, True, "" : pupevent 836
    End If
...
Sub RightRampDone_Hit
    ...
    if LastSwitchHit = "RightRampDone" Then
        Addscore jackpot(CurrentPlayer)
        DMD CL("COMBO"), CL(jackpot(CurrentPlayer)), "_", eNone, eBlinkFast, eNone, 1000, True, "" : pupevent 835
    End If
...
Sub StartBattle
    ...
    Select Case NewBattle
        Case 1 'Sand Worms = Super Spinners
            DMD CL("SAND WORMS"), CL("SHOOT THE SPINNERS"), "", eNone, eNone, eNone, 1500, True, "" : pupevent 810
        ...
        Case 2 'Jopati Kolona = Super Pop Bumpers
            DMD CL("JOPATI KOLONA"), CL("HIT THE POP BUMPERS"), "", eNone, eNone, eNone, 1500, True, "" : pupevent 811
        ...
        Case 3 'Sand Worm Ride = Ramps
            DMD CL("SAND WORM RIDE"), CL("SHOOT THE RAMPS"), "", eNone, eNone, eNone, 1500, True, "" : pupevent 812
        ...
        Case 4 'Karnak = Orbits
            DMD CL("THE SARDAUKAR"), CL("SHOOT THE ORBITS"), "", eNone, eNone, eNone, 1500, True, "" : pupevent 813
        ...
        Case 5 'Gaius Mohiam = Shoot the lights 2
            DMD CL("GAIUS MOHIAM"), CL("SHOOT THE LIGHTS"), "", eNone, eNone, eNone, 1500, True, "" : pupevent 814
        ...
        Case 6 'Sand Storm = Shoot the lights 1
            DMD CL("SAND STORM"), CL("SHOOT THE LIGHTS"), "", eNone, eNone, eNone, 1500, True, "" : pupevent 815
            DOF 166, DOFPulse			'JWK
            Light44.State = 2
            ChangeGi orange
        Case 7 'Harkonnens=  Target Frenzy
            DMD CL("HARKONNENS"), CL("SHOOT THE TARGETS"), "", eNone, eNone, eNone, 1500, True, "" : pupevent 816
        ...
        Case 8 'Glossu Rabban = Left & Right Targets
            DMD CL("GLOSSU RABBAN"), CL("SHOOT THE TARGETS"), "", eNone, eNone, eNone, 1500, True, "" : pupevent 817
        ...
        Case 9 'Jamis Fremen = Captive Ball
            DMD CL("JAMIS FREMEN"), CL("SHOOT CAPTIVE BALL"), "", eNone, eNone, eNone, 1500, True, "" : pupevent 818
        ...
        Case 10 'Hunter Seeker = Ramps and Orbits
            ...
            DMD CL("HUNTER SEEKER"), CL("SHOOT RAMPS ORBITS"), "", eNone, eNone, eNone, 1500, True, "" : pupevent 819
        ...
        Case 11 'Bene Gesserit = Blue Targets
            DMD CL("BENE GESSERIT"), CL("SHOOT BLUE TARGETS"), "", eNone, eNone, eNone, 1500, True, "" : pupevent 820
            DOF 171, DOFPulse			'JWK
            LightSeqBlueTargets.Play SeqRandom, 10, , 1000
            TargetHits11 = 0
            ChangeGi orange
        Case 12 'Shield Training = Super Loops
            DMD CL("SHIELD TRAINING"), CL("SHOOT THE LOOPS"), "", eNone, eNone, eNone, 1500, True, "" : pupevent 821
        ...
        Case 13 'TBaron Vladimir = Follow the Lights 1
            DMD CL("BARON VLADIMIR"), CL("SHOOT LIT LIGHTS"), "", eNone, eNone, eNone, 1500, True, "" : pupevent 822
        ...
        Case 14 'Feyd Rautha = Follow the Lights 2
            DMD CL("FEYD RAUTHA"), CL("SHOOT LIT LIGHTS"), "", eNone, eNone, eNone, 1500, True, "" : pupevent 823
            DOF 173, DOFPulse			'JWK
            FollowTheLights.Enabled = 1
            AddMultiball 2   
            StartJackpots
        ...
        Case 15 'The Emperor - the final battle
            DMD CL("THE EMPEROR"), CL("SHOOT THE JACKPOTS"), "", eNone, eNone, eNone, 1500, True, "" : pupevent 824
...
Sub WinBattle
    ...
    LightEffect 2
    GiEffect 2
    DMD "", CL("BATTLE COMPLETED"), "_", eNone, eBlinkFast, eNone, 1000, True, "fx_Explosion01" : pupevent 809
    DOF 139, DOFPulse
    tmp = INT(RND * 4)
    Select Case tmp
...
cPuPPack = "DUNE"    ' name of the PuP-Pack / PuPVideos folder for this table
